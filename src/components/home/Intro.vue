<template>
  <section class="scene-intro" id="intro">
    <div class="static-container">
      <v-btn ref="ufo" icon @click="title()">
        <svg
          version="1.1"
          id="Layer_1"
          ...
          x="0px"
          y="0px"
          viewBox="0 0 280.058 280.058"
          style="enable-background: new 0 0 280.058 280.058"
          xml:space="preserve"
        >
          <g>
            <path
              style="fill: #324d5b"
              d="M140.027,214.41c-14.491,0-26.253,11.761-26.253,26.253s11.761,26.253,26.253,26.253
		...
		c-14.491,0-26.253,11.752-26.253,26.253s11.761,26.253,26.253,26.253s26.253-11.752,26.253-26.253S84.511,196.91,70.02,196.91z"
            ...
            <path
              style="fill: #f4b459"
              d="M59.536,129.859c44.376-27.346,116.325-27.346,160.709,0s44.376,71.678,0,99.025
		s-116.334,27.346-160.709,0S15.152,157.206,59.536,129.859z"
            />
            <path
              style="fill: #324d5b"
              d="M41.02,81.222c54.675-32.466,143.339-32.466,198.032,0c54.675,32.466,54.675,85.102,0,117.568
		c-54.693,32.474-143.356,32.474-198.032,0C-13.673,166.324-13.673,113.688,41.02,81.222z"
            />
            <path
              style="fill: #e4e7e7"
              d="M140.027,13.142c48.331,0,87.509,39.178,87.509,87.509s-39.178,70.007-87.509,70.007
		s-87.509-21.676-87.509-70.007S91.696,13.142,140.027,13.142z"
            />
            <path
              style="fill: #3db39e"
              d="M189.898,160.768c1.698-5.154,2.634-10.659,2.634-16.364v-43.755
		...
		c14.15,6.668,31.319,9.888,49.871,9.888C158.57,170.656,175.739,167.436,189.898,160.768z"
            ...
            <path
              style="fill: #ffffff"
              d="M140.027,83.147c14.491,0,26.253,11.752,26.253,26.253c0,14.509-11.761,26.261-26.253,26.261
		c-14.491,0-26.253-11.752-26.253-26.261C113.774,94.9,125.535,83.147,140.027,83.147z"
            />
            <path
              style="fill: #324d5b"
              d="M140.027,100.649c4.839,0,8.751,3.92,8.751,8.751c0,4.839-3.912,8.751-8.751,8.751
...
<script lang="ts">
import Vue from "vue";
import { suckText, suckImage } from "@/plugins/animejs/Ufo";
...
export default Vue.extend({
  ...
  methods: {
    title(): void {
      ...
      suckImage((this.$refs.ufo as Vue).$el as Element);
    },
  },
});
</script>
