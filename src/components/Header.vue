<template>
  <v-app-bar app flat color="transparent">
    ...
    <v-btn
      ...
      small
      target="_blank"
      href="https://www.linkedin.com/in/alexandre-cortez-43b400169/"
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
        <title id="LinkedinIcoTitle">LinkedIn profile</title>
        <path
          fill="#fff"
    ...
    <v-btn
      ...
      small
      target="_blank"
      href="https://github.com/CortezSMz"
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
        <title id="LinkedinIcoTitle">GitHub profile</title>
